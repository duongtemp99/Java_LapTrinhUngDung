...
public class baitap5 extends JFrame{
	public baitap5(String title) {
		...
		final JTextField txtqk =new JTextField(15);
		pnCenter.add(pnkq);
		...
		//pnCenter.add(lblq,BorderLayout.NORTH);
		...
		pnSouth.setLayout(new BoxLayout(pnSouth	, BoxLayout.Y_AXIS)); //chỉnh kiểu south
		...
		// tạo button cho pnsouth
				...
				// add nút 
				pnSouth.add(btngiai);
				pnSouth.add(Box.createVerticalStrut(15));
				pnSouth.add(btnxoatrang);
				pnSouth.add(Box.createVerticalStrut(15));
				pnSouth.add(btnthoat);
				pnSouth.add(Box.createVerticalStrut(15));
				//pnSouth.add(btngiai, "North",1);
